...
# DPME: 2. Copy the contents of m3_drive_inches_via_library.py and paste that text into this file below these comments.
...
def main():
    ...
    while True:
        ...
        if speed_deg_per_second == 0:
            break
        turn_degrees = int(input("Turn (0 to 900 degrees): "))
        if turn_degrees == 0:
            break
        robot.turn(turn_degrees, speed_deg_per_second)
